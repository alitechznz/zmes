								...
								<div class="tab-pane active" id="messages" role="tabpanel">
									<div class="chat-box-one-side3">
										<div class="media-list media-list-hover">
											<div class="media">
											  <a class="align-self-center mx-0" href="#"><img class="avatar avatar-lg" src="../images/avatar/2.jpg" alt="..."></a>
											...
											<div class="media">
											  <a class="align-self-center mx-0" href="#"><img class="avatar avatar-lg" src="../images/avatar/3.jpg" alt="..."></a>
											  <div class="media-body">
												<p>
											...
											<div class="media">
											  <a class="align-self-center mx-0" href="#"><img class="avatar avatar-lg" src="../images/avatar/4.jpg" alt="..."></a>
											  <div class="media-body">
												<p>
											...
											<div class="media">
											  <a class="align-self-center mx-0" href="#"><img class="avatar avatar-lg" src="../images/avatar/5.jpg" alt="..."></a>
											  <div class="media-body">
												<p>
											...
											<div class="media">
											  <a class="align-self-center mx-0" href="#"><img class="avatar avatar-lg" src="../images/avatar/6.jpg" alt="..."></a>
											  <div class="media-body">
												<p>
											...
											<div class="media">
											  <a class="align-self-center mx-0" href="#"><img class="avatar avatar-lg" src="../images/avatar/7.jpg" alt="..."></a>
											  <div class="media-body">
												<p>
