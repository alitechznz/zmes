				...
				<div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<select class="form-control select2" style="width: 100%;" name="position">
						  <option selected="selected" value="Head">Head</option>
						  <option value="laboratory">Analyst</option>
						  <option value="Custodian">Custodian</option>
						  <option value="Food">Office (Food)</option>
						  <option value="Drug">Office (Drug & Cosmetics)</option>
						  <option value="CustAnalyst">Custodian & Analyst</option>
						</select>
					</div>
                </div>
				<div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	 <div class="input-group">
						  ...
						  <input type="text" class="form-control"  placeholder="Enter country code, eg, +255777000111" data-mask name="phone">
						</div>
                  	</div>
                </div>
				<div class="form-group">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_position" class="col-sm-3 control-label">Position</label>
                   	...
                   	<div class="col-sm-9">
                    	<select class="form-control select2" id="edit_position" style="width: 100%;" name="position">
						  <option selected="selected" value="Head">Head</option>
						  <option value="laboratory">Analyst</option>
						  <option value="Custodian">Custodian</option>
						  <option value="Food">Office (Food)</option>
