    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	    <h4 class="modal-title"><i class="fa fa-file"></i> Reports<b><span class="agenda_name"></span></b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="includes/controller.php">
            		<input type="hidden" class="agendaid" name="id">
            		<div class="text-center">
	                	<a href="anual.php" class"a"><p><i class="fa fa-file"></i> ANUAL REPORTS </p></a> <a href="quartely.php" class"a"><p> <i class="fa fa-file"></i> QUARTELY REPORTS </p></a>
