          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="includes/controller.php">
            		...
            		<div class="text-center">
	                	<p>Are you sure want to delete Agenda?</p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Tittle</label>
                  	<div class="col-sm-9">
			    ...
			    <div class="form-group">
          		  ...
          		  <div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Date</label>
                  	<div class="col-sm-9">
          	...
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
            	<button type="submit" class="btn btn-success btn-flat" name="editoutcome"><i class="fa fa-check-square-o"></i> Save</button>
            	</form>
          	</div>
        </div>
    </div>
