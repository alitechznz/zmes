  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Laboratory Remark</li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT * FROM submission where status3 = '1'";
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
						  ...
						  <td><?php echo $row['ed']; ?></td>
                          <td>
                            <button class="btn btn-success btn-sm edit btn-flat" data-id="<?php echo $row['sc']; ?>"><i class="fa fa-edit"></i> Edit</button>
                            <button class="btn btn-danger btn-sm delete btn-flat" data-id="<?php echo $row['sc']; ?>"><i class="fa fa-trash"></i> Delete</button>
                          </td>
                        </tr>
                      <?php
                    }
