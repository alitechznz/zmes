        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 box-body">
                 <form role="form" action="assign.php?sample=<?php echo $getid; ?>" method="post" enctype="multipart/form-data" >
                     <!-- text input -->
                     <?php
		     ...
		     <div class="row">
                  ...
                  <form action="parameter_add.php" method="post">
                       <div class="row">
            			   <div class="col-xs-12">
                               <label>Test Requested:</label>
                                <input type="text" class="form-control" id="parameter"  name="parameter" required>
                                <input type="hidden" class="form-control" id="sampleCode"  name="sampleCode" value="<?php echo $_GET['sample']; ?>">
                            </div>
                          </div></br>
                                <div class="box-footer">
                                         ...
                                         $nm =1;
        							      ...
        							      while($row=mysqli_fetch_array($result)) {
                                           ...
                                           echo '<tr>';
                                              ...
                                              echo "<td>
                                                        <a href='parameter_delete.php?sid=".$row['id']."&sample=".$row['SampleID']."' class='btn btn-danger btn-sm btn-flat'><i class='fa fa-trash'></i> Delete</a>
                            				        </td>";
