...
$data ='';
$data .='<br /><br /><br /><p style="text-align: center; margin-top: 10%;"><b>LABORATORY WORK SHEET FOOD ANALYSIS</b></p><br />';
...
$data .='
    ...
    <span><b>1.0&emsp;Sample Information</b><br />
		 ...
		 <span>1.3&emsp;Application no/Customer code number (if applicable):&emsp;'.$AppNumber.'</span>
	</span><br />
	
    <span><br /><b>2.0&emsp;Test Method/Specification</b><br />
	     <span>2.1&emsp;Test Method indicated in section 7.0:&emsp;'.$method.'</span><br />
         <span>2.2&emsp;Product specification:&emsp;'.$ProductSpecification.'</span><br />
	</span><br />

    <span style="height:600px;"><b>3.0&emsp;Equipment and Glassware</b><br /><p></p>
...
$mpdf->SetHTMLHeader($dataheader);
	...
	$data1 ='<br /><br /><br /><br /><br /><br />
        <p style="height: 300px;"><b>4.0&emsp;Sample Preparation (if applicable)</b><br /><span> (Describe sample preparation steps actually performed)</span></p><br />
		'.$SamplePrep.'
	
	<br /><span style="height:450px;"><b>5.0&emsp;Reagent and Chemicals</b><br />
	    <p></p>
	     <table border="1" cellpadding="5" cellspacing="5" width="100%" style="border-collapse:collapse;">
			<tr>
				<td><b>S/N</b></td>
	...
	<span style="height:450px;"><b>7.0&emsp;Results</b><br /><p></p>
	     <table border="1" cellpadding="5" cellspacing="5" width="100%" style="border-collapse:collapse;">
			<tr>
				<td><b>S/N</b></td>
	...
	<span style="height:450px;"><b>8.0&emsp;Remarks</b>
	    <br />
	    <p>'.$remarks.'</p>
