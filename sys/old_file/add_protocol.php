    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Assign Protocol Type</h3>
        ...
        <div class="box-body">
            <div class="row">
			  ...
			  <div class="form-group">
                  <label for="exampleInputEmail1">Protocol Type </label>
                  <input type="text" class="form-control" id="" placeholder="Enter email" name="name">
                </div>
			  
			   <div class="form-group">
                  <label for="exampleInputEmail1">Input Sample Type </label>
				 ...
				 <div class="form-group">
                  <label for="exampleInputEmail1">Output Sample Type </label>
                 <select class="form-control select2" name="status">
                  <option selected="selected"></option>
                  <option>Expenditure</option>
