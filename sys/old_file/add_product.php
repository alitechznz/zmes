                 ...
                 <form role="form" action="product_add.php" method="post" enctype="multipart/form-data">
                     <!-- text input -->
						 <div class="form-group">
						  ...
						  <input type="text" class="form-control" id="" placeholder="Enter product type..." name="method">
						</div>
						<div class="form-group">
...
<!-- jQuery 3 -->
  ...
  <?php include 'includes/product_model.php'; ?>
</div>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('.employee_id').html(response.Product);
      $('#edit_name').val(response.Product);
