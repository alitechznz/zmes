          	...
          	<div class="modal-body">
							...
							$year = date('Y');
							   $query="SELECT * FROM sample_submit WHERE Year='$year'";
											if($result=mysqli_query($conn, $query)) {;
												...
												echo "<input type='text' class='form-control' id='code' name='code' value='ZFDA-F/".$year."/".$rowcount."' readonly />";
												// Free result set
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
                  	...
                  	<div class="col-sm-9">
					 <select class="form-control select2" id="aina" name="aina">
...
`				<h4>CUSTOMER INFORMATION</h4>
               <div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Customer Name</label>

                  	<div class="col-sm-9">
                    	 <select class="form-control select2" id="customer" name="customer" onchange="Showcustomer(this.value)">
									  <option selected="selected">Select</option>
									  <?php 
										 require('includes/conn.php');
