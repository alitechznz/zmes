          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="attendance_add.php">
          		  <div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Client Name</label>
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">Date In</label>
				...
				<div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">Date Out</label>

                    <div class="col-sm-9"> 
                      <div class="date">
                        <input type="text" class="form-control" id="datepicker_add1" name="date" required>
                      </div>
                    </div>
                </div>
                <div class="form-group">
				...
				<div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Hotel Name</label>
				...
				<div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">No of Pax</label>
				...
				<div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Flight Details + Time</label>

                  	<div class="col-sm-9">
                    	<textarea col="6" type="text" class="form-control" id="employee" name="employee" required></textarea>
                  	</div>
                </div>
				<div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Ferry Details + Time</label>
