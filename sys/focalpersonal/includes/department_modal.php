    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>New Department</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="department_add.php">
				<div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Department Name</label>
          		 ...
          		 <div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Leader </label>

                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="employee" name="leader" required>
                  	</div>
                </div>
				<div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_firstname" class="col-sm-3 control-label">Department Name</label>
                ...
                <div class="form-group">
                    <label for="edit_address" class="col-sm-3 control-label">Leader </label>
