          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          		  <div class="form-group">
                  	<label for="firstname" class="col-sm-3 control-label">I (Staff Name)</label>
                ...
                <div class="form-group">
                  	<label for="lastname" class="col-sm-3 control-label">TO (Head Of Lab)</label>
                ...
                <div class="form-group">
                  	<label for="address" class="col-sm-3 control-label">Sample code number</label>

                  	<div class="col-sm-9">
                      <input type="text" class="form-control" name="codenumber" id="codenumber" required>
                  	</div>
                </div>
                <div class="form-group">
                  	<label for="datepicker_add" class="col-sm-3 control-label">Common Name</label>
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">Quantity / Number</label>
                ...
                <div class="form-group">
                    <label for="gender" class="col-sm-3 control-label">Manufactured date:</label>

                    <div class="col-sm-9"> 
                      <input type="date" class="form-control" id="date-timepicker1" placeholder="Man. date" name="md">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                     <input type="date" class="form-control" id="date-timepicker1" placeholder="Expiry. date" name="md">
                    </div>
                </div>
                <div class="form-group">
                    <label for="schedule" class="col-sm-3 control-label">Submission Date & Time</label>
