          	...
          	<div class="modal-body">
							...
							$year = date('Y');
							   $query="SELECT * FROM sample_submit WHERE Year='$year'";
											if($result=mysqli_query($conn, $query)) {;
												...
												echo "<input type='text' class='form-control' id='code' name='code' value='ZFDA/".$year."/".$rowcount."' readonly />";
												// Free result set
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="date" class="form-control" id="subdate" name="subdate" value="<?php echo date('Y-m-d'); ?>" readonly />
                  	</div>
                </div>
          	</div>
