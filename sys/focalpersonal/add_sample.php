    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Assign Sample</h3>
        ...
        <div class="box-body">
            <div class="row">
               ...
               <input type="number" class="form-control"  placeholder="Enter email" name="name">
                </div>
               ...
               <input type="number" class="form-control"  placeholder="Enter email" name="name">
                ...
                <select class="form-control select2" name="status">
				 ...
				 <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="date-timepicker1" placeholder="Enter email" name="name">
                </div>
