                ...
                <div class="col-md-4 box-body">
                 <form role="form" action="php/schoolInfo.php" method="post" enctype="multipart/form-data">
					 ...
					 <div class="form-group">
					  ...
					  <input type="text" class="form-control" id="" placeholder="Test Parameters" name="TestParameters">
					</div>
					<div class="form-group">
					  <label for="exampleInputEmail1">Method </label>
					  <input type="text" class="form-control" id="" placeholder="Method" name="Method">
					</div>
					<div class="form-group">
					  <label for="exampleInputEmail1">Specifications </label>
					  <input type="text" class="form-control" id="" placeholder="Specifications" name="Specifications">
					</div>
					 
					<div class="form-group">
					  <label for="exampleInputEmail1">Results </label>
					  <input type="text" class="form-control" id="" placeholder="Results" name="Results">
					</div>
                    <div class="form-group">
                      <label>Remarks</label>
