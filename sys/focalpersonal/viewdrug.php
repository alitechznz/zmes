                   ...
                   <!-- prepare the summary of the lab test -->
                    <div class="box-body">
                        <div class="row">
							...
							<form role="form" action="php/finished.php" method="post" enctype="multipart/form-data">
                                 <!-- text input -->
                                  <?php 
							     $getid =$_GET['id'];
							     $gettype =$_GET['type'];
							   ?>
							    <input type="hidden" name="sampleID" value="<?php echo $getid; ?>" />
								 ...
								 <input type="hidden" name="code" value="<?php  echo $_GET['code']; ?>" />
								<div class="form-group">
            					  <label for="exampleInputEmail1">Checker</label>
            					  <input type="text" class="form-control" id="" placeholder="Analysed by" name="analysedBy" value="<?php echo $user['Fullname']; ?>" readonly>
            					</div>
            					<div class="form-group">
                                  <label>Remarks</label>
                                  <textarea class="form-control" placeholder="Remarks ..." name="comment" required></textarea>
                                </div>
