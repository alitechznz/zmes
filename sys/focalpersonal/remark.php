    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">ANALYSED REMARKS</h3>
                 ...
                 <form role="form" action="php/schoolInfo.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
					  ...
					  <input type="text" class="form-control" id="" placeholder="Analysed by" name="TestParameters">
					</div>
					<div class="form-group">
					  <label for="exampleInputEmail1">Signature </label>
					  <input type="text" class="form-control" id="" placeholder="Signature" name="Signature">
					</div>
					<div class="form-group">
