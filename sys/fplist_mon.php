...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       MONITORING REPORT LISTS
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Monitoring</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab"><b>KPI</b></a></li>
			  <li><a href="#tab_2" data-toggle="tab"><b>M&E PLAN</b></a></li>
              <li><a href="#tab_3" data-toggle="tab"><b>RESOURCE TRACKING</b></a></li>
              <li><a href="#tab_4" data-toggle="tab"><b>QUARTELY REPORTS</b></a></li>
              <li><a href="#tab_5" data-toggle="tab"><b>ANNUAL REPORTS</b></a></li>
            </ul>
                                      ...
                                      while($row = mysqli_fetch_array($result)) {	
                                          ...
                                          $Type = $row['dateline'];
                                            ...
                                            <td>
                                                ...
                                                <a href='time_extend.php?xyz=".$id_get."' class='btn btn-primary btn-sm  btn-flat'><i class='fa fa-edit'></i> Extend</button>
                                            </td>
                                        </tr>";
                                    }
