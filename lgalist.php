                           ...
                           if(isset($_GET['type'])){
                               if($_GET['type'] == 'agenda'){
                                $type = "Total Agenda";
                                  ...
                                  $type = "Total Projects";
                               } elseif($_GET['type'] == 'finished'){
                                    $type = "Finished Project(s)";
                               } elseif($_GET['type'] == 'remaining'){
                                    $type = "Remained Project(s)";
                              } else{
                                $type = $_GET['type'];
                              }
                             
                           }
                           echo '<h3 class="box-title">Project List </h3>';
                        ?>
