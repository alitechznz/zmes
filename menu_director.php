<aside class="main-sidebar">
    ...
    <section class="sidebar">
		<div class="user-profile px-20 py-15">
			<div class="d-flex align-items-center">			
				<div class="image">
				  <img src="images/smz-logo.png" class="avatar avatar-lg bg-primary-light" alt="User Image">
				</div>
				<div class="info">
					<a class="dropdown-toggle px-20" data-toggle="dropdown" href="#">Ali O Ali</a>
			...
			<ul class="list-inline profile-setting mt-30 mb-20 d-flex justify-content-between">
				...
				<li><a href="php/logout.php" data-toggle="tooltip" data-placement="top" title="Logout"><i data-feather="log-out"></i></a></li>
			</ul>
        </div>
    ...
    <li class="header">Master Configuration </li>
    <li>
          <a href="agenda.php">
        ...
        <li class="header">Data Entry Management </li>
        <li>
            <a href="annualreport.php">
                <i class="icon-Write"><span class="path1"></span><span class="path2"></span></i>
