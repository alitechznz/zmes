		...
		<section class="content">
          ...
          <div class="row">
             <div class="col-lg-12 col-12">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".submitflproject">
                    Submit new project
                </button>
              </div>
          </div><br />
                                        ...
                                        <tbody>
                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                    ...
                                                    <button class='btn btn-warning btn-sm fl_proj_annual' data-id="1" data-toggle='modal' data-target='.annual'><span class='icon-Write'><span class='path1'></span><span class='path2'></span></span>Annual</button>
                                                    <button class='btn btn-primary btn-sm fl_proj_quarter' data-id="1" data-toggle='modal' data-target='.quarter'><span class='icon-Write'><span class='path1'></span><span class='path2'></span>Quarter</span></button>
                                                    <button class='btn btn-danger btn-sm fl_proj_track' data-id="1" data-toggle='modal' data-target='.track'><span class='icon-Trash1'><span class='path1'></span><span class='path2'></span>Resource</span></button>
                                                 </td>
                                             </tr>
